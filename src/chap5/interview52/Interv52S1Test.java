...
public class Interv52S1Test {
	...
	public void test1() {
		...
		Interv52ListNode result = Interview52S1.findFirstCommonNode(node1, node4);
	...
	public void test2() {
		...
		Interv52ListNode result = Interview52S1.findFirstCommonNode(node1, node5);
		if(result != null) {
			System.out.println(result.value);
		}else {
	...
	public void test4() {
		...
		Interv52ListNode result = Interview52S1.findFirstCommonNode(node1, node1);
		if(result != null) {
			System.out.println(result.value);
		}else {
			System.out.println("No Common node.");
	...
	public void test5() {
		...
		Interv52ListNode result = Interview52S1.findFirstCommonNode(node1, null);
		if(result != null) {
			System.out.println(result.value);
		}else {
			System.out.println("No Common node.");
	...
	public void test6() {
		...
		Interv52ListNode result = Interview52S1.findFirstCommonNode(null, null);
		if(result != null) {
			System.out.println(result.value);
		}else {
			System.out.println("No Common node.");
